...
class Vectorize_testinstances(Task):
    ...
    def out_test(self):
        return self.outputfrominput(inputformat='test', stripextension='.features.npz'\
, addextension='.vectors.npz')
...
class Vectorize(WorkflowComponent):
    ...
    def setup(self, workflow, input_feeds):
        ...
        train_vectors = workflow.new_task('vectorize_traininstances', Vectorize_traininstances, autopass=True, weight=self.weight, prune=self.prune)
